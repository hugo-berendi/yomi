...
let
  ...
  migaduMail =
    ...
    let
      ...
      keyValue = keyNum: if at == "" then "key${builtins.toString keyNum}.hugo-berendi.de._domainkey.migadu.com." else "key${builtins.toString keyNum}.${at}.hugo-berendi.de._domainkey.migadu.com.";
    in
    [
      {
        inherit at;
