...
lib.fix (self: {
  ...
  "Rosé Pine" = fetchurl {
    url = "https://raw.githubusercontent.com/rose-pine/discord/main/rose-pine.theme.css";
    sha256 = "1dgq1sdy07m0ra3ysn1g29y2ba37cna3sxy2vv125f2pjmdx0vci";
  };
  "Rosé Pine Dawn" = fetchurl {
    url = "https://raw.githubusercontent.com/rose-pine/discord/main/rose-pine.theme.css";
    sha256 = "1dgq1sdy07m0ra3ysn1g29y2ba37cna3sxy2vv125f2pjmdx0vci";
  };
  default.dark = self."Rosé Pine";
  default.light = self."Rosé Pine Dawn";
})
